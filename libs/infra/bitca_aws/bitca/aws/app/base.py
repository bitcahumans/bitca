...
from bitca.aws.context import AwsBuildContext
...
if TYPE_CHECKING:
    ...
    from bitca.aws.resource.ecs.container import EcsContainer
...
class AwsApp(InfraApp):
    ...
    def get_load_balancer_security_groups(self) -> Optional[List["SecurityGroup"]]:
        from bitca.aws.resource.ec2.security_group import InboundRule, SecurityGroup
    ...
    def security_group_definition(self) -> "SecurityGroup":
        from bitca.aws.resource.ec2.security_group import InboundRule, SecurityGroup
        from bitca.aws.resource.reference import AwsReference
    ...
    def build_resources(self, build_context: AwsBuildContext) -> List["AwsResource"]:
        ...
        from bitca.aws.resource.ecs.service import EcsService
        from bitca.aws.resource.ecs.task_definition import EcsTaskDefinition
        from bitca.aws.resource.ecs.volume import EcsVolume
        from bitca.aws.resource.elb.listener import Listener
        from bitca.aws.resource.elb.load_balancer import LoadBalancer
        from bitca.aws.resource.elb.target_group import TargetGroup
