...
from bitca.infra.app import InfraApp
from bitca.infra.context import ContainerContext
...
class DockerApp(InfraApp):
    ...
    def get_container_volumes(self, container_context: ContainerContext) -> Dict[str, dict]:
        from bitca.utils.defaults import get_default_volume_name
    ...
    def build_resources(self, build_context: DockerBuildContext) -> List["DockerResource"]:
        from bitca.docker.resource.base import DockerResource
        from bitca.docker.resource.container import DockerContainer
        from bitca.docker.resource.network import DockerNetwork
    ...
    def get_infra_resources(self) -> Optional[Any]:
        from bitca.docker.resources import DockerResources
