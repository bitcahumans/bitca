...
from bitca.docker.api_client import DockerApiClient
from bitca.docker.app.base import DockerApp
from bitca.docker.context import DockerBuildContext
from bitca.docker.resource.base import DockerResource
from bitca.infra.resources import InfraResources
from bitca.utils.log import logger
from bitca.workspace.settings import WorkspaceSettings
...
class DockerResources(InfraResources):
    ...
    def create_resources(
        ...
        from bitca.cli.console import confirm_yes_no, print_heading, print_info
        from bitca.docker.resource.types import DockerContainer, DockerResourceInstallOrder
