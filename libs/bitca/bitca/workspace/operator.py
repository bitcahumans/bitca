...
from bitca.api.schemas.team import TeamIdentifier, TeamSchema
from bitca.api.schemas.workspace import (
    WorkspaceCreate,
    WorkspaceEvent,
    WorkspaceSchema,
    WorkspaceUpdate,
)
from bitca.api.workspace import log_workspace_event
from bitca.cli.config import AgnoCliConfig
from bitca.cli.console import (
    console,
...
from bitca.infra.resources import InfraResources
from bitca.utils.common import str_to_int
from bitca.utils.log import logger
from bitca.workspace.config import WorkspaceConfig
from bitca.workspace.enums import WorkspaceStarterTemplate
...
def create_workspace(
    ...
    from bitca.cli.operator import initialize_agno
    from bitca.utils.filesystem import rmdir_recursive
    from bitca.utils.git import GitCloneProgress
    from bitca.workspace.helpers import get_workspace_dir_path
...
def setup_workspace(ws_root_path: Path) -> Optional[WorkspaceConfig]:
    ...
    from bitca.cli.operator import initialize_agno
    from bitca.utils.git import get_remote_origin_for_dir
    from bitca.workspace.helpers import get_workspace_dir_path
    ...
    if agno_config.user is None:
        from bitca.api.user import create_anon_user
    ...
    if agno_config.user is not None:
        ...
        if ws_schema is None or ws_schema.id_workspace is None:
            from bitca.api.team import get_teams_for_user
            from bitca.api.workspace import create_workspace_for_user
        ...
        if git_remote_origin_url is not None and ws_schema is not None and ws_schema.git_url != git_remote_origin_url:
            from bitca.api.workspace import update_workspace_for_team, update_workspace_for_user
