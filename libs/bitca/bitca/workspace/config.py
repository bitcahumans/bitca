...
from bitca.api.schemas.team import TeamSchema
from bitca.api.schemas.workspace import WorkspaceSchema
from bitca.infra.base import InfraBase
...
class WorkspaceConfig(BaseModel):
    ...
    def workspace_settings(self) -> Optional[WorkspaceSettings]:
        ...
        try:
            from bitca.utils.py_io import get_python_objects_from_module
