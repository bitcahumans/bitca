...
from bitca.models.base import Model, StreamData
...
class AwsBedrock(Model):
    ...
    def get_aws_region(self) -> Optional[str]:
        ...
        from bitca.constants import AWS_REGION_ENV_VAR
    ...
    def get_aws_profile(self) -> Optional[str]:
        ...
        from bitca.constants import AWS_PROFILE_ENV_VAR
