...
from bitca.cli.console import print_heading, print_info
from bitca.cli.settings import AGNO_CLI_CONFIG_DIR, agno_cli_settings
from bitca.infra.resources import InfraResources
from bitca.utils.log import logger


def delete_agno_config() -> None:
    from bitca.utils.filesystem import delete_from_fs
...
def authenticate_user() -> None:
    ...
    """
    from bitca.api.schemas.user import UserSchema
    from bitca.api.user import authenticate_and_get_user
    from bitca.cli.auth_server import (
        get_auth_token_from_web_flow,
        get_port_for_auth_server,
    )
    from bitca.cli.credentials import save_auth_token
