...
from bitca.cli.ws.ws_cli import ws_cli
from bitca.utils.log import set_log_level_to_debug
...
def ping(
    ...
    from bitca.api.user import user_ping
    from bitca.cli.console import print_info
...
def config(
    ...
    from bitca.cli.console import log_config_not_available_msg
    from bitca.cli.operator import initialize_agno
...
def set(
    ...
    """
    from bitca.workspace.operator import set_workspace_as_active
...
def start(
    ...
    from bitca.cli.config import AgnoCliConfig
    from bitca.cli.console import log_config_not_available_msg
    from bitca.cli.operator import initialize_agno, start_resources
...
def stop(
    ...
    from bitca.cli.config import AgnoCliConfig
    from bitca.cli.console import log_config_not_available_msg
    from bitca.cli.operator import initialize_agno, stop_resources
...
def patch(
    ...
    from bitca.cli.config import AgnoCliConfig
    from bitca.cli.console import log_config_not_available_msg
    from bitca.cli.operator import initialize_agno, patch_resources
