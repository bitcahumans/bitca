...
from bitca.utils.log import logger, set_log_level_to_debug
...
def create(
    ...
    from bitca.workspace.operator import create_workspace
...
def setup(
    ...
    from bitca.workspace.operator import setup_workspace
...
def up(
    ...
    from bitca.utils.resource_filter import parse_resource_filter
    from bitca.workspace.config import WorkspaceConfig
    from bitca.workspace.helpers import get_workspace_dir_path
    from bitca.workspace.operator import setup_workspace, start_workspace
...
def down(
    ...
    from bitca.workspace.config import WorkspaceConfig
    from bitca.workspace.helpers import get_workspace_dir_path
    from bitca.workspace.operator import setup_workspace, stop_workspace
...
def patch(
    ...
    from bitca.workspace.config import WorkspaceConfig
    from bitca.workspace.helpers import get_workspace_dir_path
    from bitca.workspace.operator import setup_workspace, update_workspace
...
def config(
    ...
    from bitca.cli.config import AgnoCliConfig
    from bitca.cli.operator import initialize_agno
    from bitca.utils.load_env import load_env
    from bitca.workspace.config import WorkspaceConfig
...
def delete(
    ...
    from bitca.cli.config import AgnoCliConfig
    from bitca.cli.operator import initialize_agno
    from bitca.workspace.operator import delete_workspace
