...
from bitca.exceptions import AgentRunException, StopAgentRun
from bitca.knowledge.agent import AgentKnowledge
from bitca.media import Audio, AudioArtifact, Image, ImageArtifact, Video, VideoArtifact
from bitca.memory.agent import AgentMemory, AgentRun
...
from bitca.reasoning.step import NextAction, ReasoningStep, ReasoningSteps
from bitca.run.messages import RunMessages
from bitca.run.response import RunEvent, RunResponse, RunResponseExtraData
...
from bitca.utils.message import get_text_from_message
from bitca.utils.safe_formatter import SafeFormatter
...
class Agent:
    ...
    def load_agent_session(self, session: AgentSession):
        ...
        from bitca.utils.merge_dict import merge_dictionaries
    ...
    def reason(self, run_messages: RunMessages) -> Iterator[RunResponse]:
        ...
        if reasoning_model.__class__.__name__ == "DeepSeek" and reasoning_model.id == "deepseek-reasoner":
            from bitca.reasoning.deepseek import get_deepseek_reasoning, get_deepseek_reasoning_agent
        ...
        if reasoning_model.__class__.__name__ == "Groq" and "deepseek" in reasoning_model.id:
            from bitca.reasoning.groq import get_groq_reasoning, get_groq_reasoning_agent
        ...
        # Get default reasoning
            ...
            from bitca.reasoning.default import get_default_reasoning_agent
            from bitca.reasoning.helpers import get_next_action, update_messages_with_reasoning
    ...
    async def areason(self, run_messages: RunMessages) -> Any:
        ...
        # Use DeepSeek for reasoning
        if reasoning_model.__class__.__name__ == "DeepSeek" and reasoning_model.id == "deepseek-reasoner":
            from bitca.reasoning.deepseek import aget_deepseek_reasoning, get_deepseek_reasoning_agent
        ...
        # Use Groq for reasoning
        if reasoning_model.__class__.__name__ == "Groq" and "deepseek" in reasoning_model.id:
            from bitca.reasoning.groq import aget_groq_reasoning, get_groq_reasoning_agent
    ...
    def log_agent_session(self):
        ...
        from bitca.api.agent import AgentSessionCreate, create_agent_session
    ...
    async def alog_agent_session(self):
        ...
        from bitca.api.agent import AgentSessionCreate, acreate_agent_session
    ...
    def log_agent_run(self) -> None:
        ...
        from bitca.api.agent import AgentRunCreate, create_agent_run
    ...
    async def alog_agent_run(self) -> None:
        ...
        from bitca.api.agent import AgentRunCreate, acreate_agent_run
