...
from bitca.api.api import api, invalid_response
from bitca.api.routes import ApiRoutes
from bitca.api.schemas.user import EmailPasswordAuthSchema, UserSchema
...
def authenticate_and_get_user(auth_token: str, existing_user: Optional[UserSchema] = None) -> Optional[UserSchema]:
    ...
    from bitca.cli.credentials import read_auth_token
