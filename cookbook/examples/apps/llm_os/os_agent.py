...
from bitca.knowledge import AgentKnowledge
...
def get_llm_os(
    ...
    if data_analyst:
        data_analyst_agent: Agent = Agent(
            ...
            instructions="Use this file for Movies data: https://bitca-public.s3.amazonaws.com/demo_data/IMDB-Movie-Data.csv",
        )
