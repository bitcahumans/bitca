"""
1. Run: `pip install openai duckduckgo-search newspaper4k lxml_html_clean bitca` to install the dependencies
...
from bitca.tools.hackernews import HackerNewsTools
