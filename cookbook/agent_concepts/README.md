...
Application of several agent concepts using bitca.
...
bitca provides 3 types of memory for Agents:

1. Chat History: The message history of the session. bitca will store the sessions in a database for you, and retrieve them when you resume a session.
...
In addition to text, bitca agents support image, audio, and video inputs and can generate image and audio outputs.

Examples with multimodal input and outputs using bitca can be found under `/cookbook/agent_concepts/storage/`
...
Examples of using storage with bitca agents can be found under `/cookbook/agent_concepts/storage/`

### Teams

Multiple agents can be combined to form a team and complete complicated tasks as a cohesive unit.

Examples of using agent teams with bitca can be found under `/cookbook/agent_concepts/teams/`
...
Examples of using tools with bitca agents can be found under `/cookbook/agent_concepts/tools/`
...
Examples of using vector databases with bitca can be found under `/cookbook/agent_concepts/vector_dbs/`
