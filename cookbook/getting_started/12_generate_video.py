"""🎥 Video Generation with ModelsLabs - Creating AI Videos with bitca
...
Run `pip install openai bitca` to install dependencies.
...
from bitca.tools.models_labs import ModelsLabTools
