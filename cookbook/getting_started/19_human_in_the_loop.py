...
This example shows how to implement human-in-the-loop functionality in your Bita tools.
It shows how to:
...
Run `pip install openai httpx rich bitca` to install dependencies.
"""
...
from bitca.exceptions import StopAgentRun
from bitca.tools import FunctionCall, tool
