# Getting Started with Bitca 🚀

This guide walks through the basics of building Agents with Bitca.
...
```bash
pip install openai duckduckgo-search yfinance lancedb tantivy pypdf requests exa-py newspaper4k lxml_html_clean sqlalchemy bitca
```
