"""🎤 Audio Input/Output with GPT-4 - Creating Voice Interactions with bitca
...
Run `pip install openai requests bitca` to install dependencies.
"""
...
from bitca.media import Audio
from bitca.models.openai import OpenAIChat
from bitca.utils.audio import write_audio_to_file
